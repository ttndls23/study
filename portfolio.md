...
* 도어락 키트 아두이노 보드를 구매하여 도어락 구현
* 라즈베리파이에 서보모터를 장착하여 보조 잠금 장치 구현
* <라즈베리파이에서 이용한 서보모터 참고 사진>![image](https://user-images.githubusercontent.com/49181283/135935078-74922aea-9d57-4336-a85f-33e77a896386.png)
* 안드로이드와 도어락은 블루투스를 통한 연결, 라즈베리파이와 안드로이드는 소켓통신을 통한 
