...
* 식당에서 소독 여부 확인, 남은 좌석 확인 등의 기능을 제공하여 높은 집단 감염의 위험성에서 벗어나고 안전한 외식생활을 가능하게 하기 위함
* 고객은 안전한 외식 가능
* 식당 입장에서는 가게 활성화 & 방문 통계를 이용한 고객 예측, 적절한 식자재 구입을 통한 식자재 낭비 감소 가능

### 사용 SW/HW

* 아두이노 MCU, RFID, 알코올 센서 - 이용중인 좌석과 소독 여부 등을 체크하기 위해 사용
* NHN-Toast - 아두이노 보드와 데이터베이스를 연결, 남은 좌석 수와 소독 여부, 고객 방문 통계 등을 체크하여 반응형 웹 사이트에 보여줌
...
* 아두이노 MCU, RFID, 알코올 센서를 이용하여 남은 좌석 수와 소독 여부를 확인
